module.exports.pacientes = function (application, req, res) {
	...
	pacientesModel.getPacientes(function (error, result) {
		res.render("usuarios/pacientes", { pacientes: result });
	});
}
...
module.exports.paciente_update = function (application, req, res) {
	...
	pacientesModel.updatePaciente(req.body.nomePaciente, req.body.emailPaciente, req.body.telefonePaciente, req.body.dataNascimento, req.body.sexo, req.body.dataCadastro, req.body.idPaciente, function (error, result) {
		res.redirect('/pacientes');
	});
}
